...
<html>
  ...
  <body>
    ...
    <div class="bg">
      ...
      <?php
        ...
        if(isset($_POST['cart'])){
          if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            if(empty($_POST['user'])) {
              $customerErr = "Please fill a valid user username";
            }
            else {
              $customer = $_POST['user'];
              $f = 1;
      ...
      <input type="text" name="user" id="user" value="<?php echo $customer;?>" style = "width: 75%; display: inline-block;">

      <input type="submit" name="cart" value="Delete" id="srcBtn" style="background-color: #BB2A2A;">

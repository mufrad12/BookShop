    ...
    <div class="bg">
      ...
      <?php
        ...
        if($conn1->connect_error) {
          ...
          $stmt1 = $conn1->prepare("select firstName, lastName, gender, dob, email, id, userName, password, conPassword from admin where userName = ? ");
        ...
        if(isset($_POST['update']) && $password==$conPassword)
        {
          ...
          if($conn2->connect_error) {
            ...
            $stmt2 = mysqli_prepare($conn2, 'update admin set firstName = ?, lastName = ?, gender = ?, dob = ?, email = ?, password = ?, conPassword = ? where userName = ?');
        ...
        if(isset($_POST['delete']))
        {
          ...
          if(mysqli_connect_error()) {
            ...
            $stmt3 = mysqli_prepare($conn3, 'delete from admin where userName=?');

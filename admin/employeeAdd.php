  ...
  <body>
    ...
    <div class="bg">
      ...
      <form name="jsForm" onsubmit="submitForm(event)">
        ...
        <input type="submit" value="Add" class="addemployeeBtn" id="submit" >
        ...
        if($conn->connect_error) {
          ...
          $stmt = $conn->prepare("insert into employee (firstName, lastName, gender, dob, email, userName, password, conPassword) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
            ...
            || email == "" || username == "" || password == "" || repassword == "") 
          {
            ...
            xhttp.onreadystatechange = function() {
              if(this.readyState == 4 && this.status == 200) {
                document.getElementById("errorMsg").innerHTML = "<b>New Employee Added Successfully</b>";
